...
const sidebarLinks = [
  ...
  { to: "/dashboard/applied", label: "Applied", icon: Briefcase },
  { to: "/dashboard/saved", label: "Saved", icon: Bookmark },
  { to: "/dashboard/eligibility", label: "AI Checker", icon: Brain },
  { to: "/dashboard/skills", label: "Skills", icon: Target },
  { to: "/dashboard/academic", label: "Academic Info", icon: GraduationCap },
            ...
            <div className="flex items-center gap-3">
              ...
              {!collapsed && (
                <div className="min-w-0">
                  ...
                  <div className="text-xs text-muted-foreground">Job Seeker</div>
                </div>
              )}
            </div>
          </div>
